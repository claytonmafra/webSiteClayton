		...
		<div class="row">
			<div class="col-sm-12">
				<h3 class="mg-md text-center tc-black">
					Erro 404 (Error 500) - Erro interno de servidor (Internal Server Error)
				</h3>
				<p class="text-center ">
					Havia um erro. Por favor tente novamente mais tarde. 
                                        (There was an error. Please try again later.)
				</p><img src="img/500.png" class="img-responsive center-block" />
			</div>
		</div>
	</div>
</div>
