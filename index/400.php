		...
		<div class="row">
			<div class="col-sm-12">
				<h3 class="mg-md text-center tc-black">
					Erro 400 (Error 400) - Solicitação Imprópria (Bad Request)
				</h3>
				<p class="text-center ">
					Seu cliente emitiu um pedido malformado ou ilegal.
                                        (Your client has issued a malformed or illegal request.)
				</p><img src="img/400.png" class="img-responsive center-block" />
			</div>
		</div>
	</div>
</div>
