					...
					<li>
						<div class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li>
									<a href="english.php" class="a-btn a-block ltc-white">English</a>
								</li>
								<li>
									<a href="#" class="a-btn a-block ltc-white">Português</a>
								</li>
							</ul>
						</div>
					</li>
...
<!-- bloc-15 -->
<div class="bloc bgc-white b-parallax tc-black" id="bloc-15">
	<div class="container bloc-lg">
		<div class="row">
			<div class="col-sm-12">
				<h3 class="mg-md text-center tc-black">
					Erro 403 (Error 403) - Acesso Negado (Forbidden)
				</h3>
				<p class="text-center ">
					Você tentou acessar algo no qual não tem autorização. Volte à HOME e tente novamente.
                                        (You tried something where you are not allowed. Back to the home and try again.)
				</p><img src="img/Proibido.jpg" class="img-responsive center-block" />
			</div>
		</div>
	</div>
</div>
...
<div class="bloc bg-crosses-l-bg bg-repeat bgc-onyx d-bloc" id="naodeixe">
	<div class="container bloc-md">
		<div class="row">
			...
			<div class="col-sm-2">
				<a class="btn  btn-glossy btn-lg btn-banana-yellow animated lightSpeedIn text-center" onclick="scrollToTarget('#contato')" data-placement="bottom" data-toggle="tooltip" title="Contato"><span class="li_megaphone icon-spacer"></span>Clique aqui</a>
			</div>
		</div>
	</div>
</div>
